...
if (Test-Path -LiteralPath $sourcePublicationPacketPath -PathType Leaf) {
  ...
  foreach ($field in @("read_only", "source_only", "manual_publish_only", "no_merge", "no_tag_creation", "no_tag_push", "no_github_release_publish", "no_asset_upload", "no_apk", "no_exe", "no_store_release", "no_trusted_signing_claim", "requires_release_handoff_summary", "requires_publication_dry_run_summary", "requires_release_handoff_ready", "requires_publication_dry_run_ready", "requires_rendered_release_notes", "requires_proof_manifest", "requires_source_archive", "requires_release_evidence_bundle", "requires_clean_clone_or_import_proof", "requires_artifact_fingerprints", "requires_input_fingerprints", "requires_input_generated_at", "requires_input_generated_at_parseable", "requires_input_generated_at_freshness", "requires_release_handoff_publication_dry_run_input_fingerprint_integrity", "requires_release_handoff_publication_dry_run_source_archive_name_binding", "carries_release_handoff_publication_dry_run_source_archive_name", "requires_release_handoff_publication_dry_run_source_archive_sha_binding", "carries_release_handoff_publication_dry_run_source_archive_sha", "requires_release_handoff_publication_dry_run_commit_sha_binding", "carries_release_handoff_publication_dry_run_commit_sha", "requires_release_handoff_publication_dry_run_evidence_bundle_preflight_commit_sha_binding", "carries_release_handoff_publication_dry_run_evidence_bundle_preflight_commit_sha", "requires_release_handoff_publication_dry_run_evidence_bundle_preflight_ref_commit_sha_binding", "carries_release_handoff_publication_dry_run_evidence_bundle_preflight_ref_commit_sha", "requires_release_handoff_windows_bundle_verifier_binding", "carries_release_handoff_windows_bundle_verifier_proof", "requires_release_handoff_github_ruleset_report_binding", "carries_release_handoff_github_ruleset_report_proof", "requires_publication_dry_run_carried_input_fingerprint_integrity", "requires_publication_dry_run_carried_artifact_fingerprint_integrity", "requires_publication_artifact_file_fingerprint_integrity", "requires_publication_artifact_root_boundaries", "requires_source_only_release_asset_allowlist", "requires_publication_artifact_file_extensions", "requires_publication_artifact_content_validation", "requires_publication_artifact_schema_validation", "requires_release_notes_claim_guard", "forbids_release_notes_tbd_placeholders", "requires_release_notes_proof_values", "requires_release_evidence_bundle_tag_binding", "requires_release_evidence_bundle_commit_sha_binding", "requires_release_evidence_bundle_source_archive_sha_binding", "requires_release_evidence_bundle_source_archive_name_binding", "requires_proof_manifest_tag_binding", "requires_proof_manifest_commit_sha_binding", "requires_proof_manifest_source_archive_sha_binding", "requires_proof_manifest_source_archive_name_binding", "requires_source_only_flags", "writes_only_ignored_build_output")) {
  ...
  $expectedPublicationPacketArtifactSchemaContracts = @{
  ...
  foreach ($artifactSchemaName in $expectedPublicationPacketArtifactSchemaContracts.Keys) {
    if ($sourcePublicationPacket.artifact_schema_contracts.$artifactSchemaName -ne $expectedPublicationPacketArtifactSchemaContracts[$artifactSchemaName]) {
      $manifestErrors.Add("config\\source-publication-packet.seed.json artifact_schema_contracts.$artifactSchemaName must stay $($expectedPublicationPacketArtifactSchemaContracts[$artifactSchemaName])")
    }
  }

  foreach ($marker in @("source-only release", "## Included", "## Not Included", "## Known Limitations", "No APK", "No EXE", "No store release", "No trusted Windows signing claim", "official binary")) {
    if (@($sourcePublicationPacket.release_notes_required_markers) -notcontains $marker) {
      $manifestErrors.Add("config\\source-publication-packet.seed.json must require release notes marker '$marker'")
    }
  }

  foreach ($proofRequirement in @("publication_dry_run.tag", "publication_dry_run.source_archive_sha256")) {
    if (@($sourcePublicationPacket.release_notes_proof_requirements) -notcontains $proofRequirement) {
      $manifestErrors.Add("config\\source-publication-packet.seed.json must require release notes proof value '$proofRequirement'")
    }
  }

  foreach ($proofRequirement in @("proof_manifest.tag", "proof_manifest.commit_sha", "proof_manifest.source_archive", "proof_manifest.source_archive_sha256", "publication_dry_run.tag", "publication_dry_run.commit_sha", "publication_dry_run.source_archive_sha256")) {
    if (@($sourcePublicationPacket.proof_manifest_proof_requirements) -notcontains $proofRequirement) {
      $manifestErrors.Add("config\\source-publication-packet.seed.json must require proof manifest proof value '$proofRequirement'")
    }
  }
  foreach ($proofRequirement in @("release_evidence_bundle.tag", "release_evidence_bundle.commit_sha", "release_evidence_bundle.source_archive", "release_evidence_bundle.source_archive_sha256", "publication_dry_run.tag", "publication_dry_run.commit_sha", "publication_dry_run.source_archive_sha256")) {
    if (@($sourcePublicationPacket.release_evidence_bundle_proof_requirements) -notcontains $proofRequirement) {
      $manifestErrors.Add("config\\source-publication-packet.seed.json must require release evidence bundle proof value '$proofRequirement'")
    }
  }
  ...
  if (Test-Path -LiteralPath $sourcePublicationPacketScriptPath -PathType Leaf) {
    ...
    foreach ($requiredPhrase in @("source-publication-packet.seed.json", "release_handoff", "publication_dry_run", "handoff_ready_for_maintainer", "ready_for_manual_review", "packet_ready_for_manual_publish_review", "manual_publish_only", "asset_upload_performed = `$false", "release_notes", "proof_manifest", "source_archive", "release_evidence_bundle", "clean_clone_or_import_proof", "input_fingerprints", "input_generated_at", "must include generated_at timestamp", "must include parseable generated_at timestamp", "has stale generated_at timestamp", "release_handoff_publication_dry_run_input_fingerprints", "release_handoff_publication_dry_run_source_archive", "release_handoff_publication_dry_run_commit_sha", "release_handoff_publication_dry_run_source_archive_sha256", "release_handoff_publication_dry_run_evidence_bundle_preflight_commit_sha", "release_handoff_publication_dry_run_evidence_bundle_preflight_ref_commit_sha", "release_handoff_windows_bundle_verifier_ok", "release_handoff_windows_bundle_verifier_summary", "release_handoff_github_ruleset_report", "release handoff summary is missing publication_dry_run_source_archive_sha256", "release handoff publication dry-run source archive SHA mismatch", "release handoff summary is missing publication_dry_run_evidence_bundle_preflight_commit_sha", "release handoff publication dry-run evidence bundle preflight commit SHA mismatch", "release handoff summary is missing publication_dry_run_evidence_bundle_preflight_ref_commit_sha", "release handoff publication dry-run evidence bundle preflight ref commit SHA mismatch", "release handoff summary is missing windows_bundle_verifier_ok", "release handoff Windows bundle verifier status mismatch", "release handoff summary is missing windows_bundle_verifier_summary", "release handoff Windows bundle verifier summary mismatch", "publication dry-run summary is missing github_ruleset_report", "release handoff summary is missing github_ruleset_report", "release handoff GitHub ruleset report mismatch", "release handoff publication dry-run input", "release handoff publication dry-run source archive name mismatch", "release handoff publication dry-run commit SHA mismatch", "handoff-carried publication dry-run", "artifact_file_fingerprints", "source publication packet artifact fingerprint mismatch", "fingerprint mismatch", "publication_dry_run_evidence_bundle_preflight_artifact_fingerprints", "artifact_roots", "source publication packet artifact path outside expected root", "allowed_release_assets", "source publication packet unexpected release asset fingerprint", "artifact_file_extensions", "source publication packet artifact file extension mismatch", "artifact_content_types", "source publication packet artifact content invalid", "artifact_schema_contracts", "source publication packet artifact schema invalid", "release_notes_required_markers", "source publication packet release notes claims invalid", "release_notes_proof_requirements", "source publication packet release notes proof mismatch", "proof_manifest_proof_requirements", "release_evidence_bundle_proof_requirements", "source publication packet release evidence bundle tag mismatch", "source publication packet release evidence bundle commit SHA mismatch", "source publication packet release evidence bundle source archive SHA mismatch", "source publication packet release evidence bundle source archive name mismatch", "source publication packet proof manifest tag mismatch", "source publication packet proof manifest commit SHA mismatch", "source publication packet proof manifest source archive SHA mismatch", "source publication packet proof manifest source archive name mismatch", "source_proof", "windows_bundle_verifier", "ZipFile", "ConvertFrom-Json", "Test-PathUnderRoot", "Assert-BuildInputPath", "SHA256", "ComputeHash", "build\source-publication-packet")) {
