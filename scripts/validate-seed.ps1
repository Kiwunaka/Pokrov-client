...
if (Test-Path -LiteralPath $releaseMergeHandoffPath -PathType Leaf) {
  ...
  foreach ($field in @("read_only", "no_merge", "no_git_push", "no_tag_creation", "no_github_release_publish", "writes_only_ignored_build_output", "requires_merge_order_summary", "requires_github_status_summary", "requires_tag_readiness_summary", "requires_publication_dry_run_summary", "requires_input_fingerprints", "requires_source_only_summary_flags", "requires_canonical_build_input_roots", "requires_input_generated_at", "requires_input_schema_versions", "requires_read_only_input_summaries", "requires_input_stack_count_consistency", "requires_error_free_input_summaries", "requires_tag_readiness_blocker_absence_consistency", "requires_tag_readiness_blocker_evidence_fields")) {
