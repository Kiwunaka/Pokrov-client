...
if (Test-Path -LiteralPath $publicationDryRunPath -PathType Leaf) {
  ...
  foreach ($field in @("read_only", "dry_run_only", "no_github_release_publish", "no_tag_push", "writes_only_ignored_build_output", "requires_source_only_evidence_bundle", "requires_release_copy_check", "github_enforcement_claim_requires_bundle_approval", "windows_bundle_verifier_claim_requires_bundle_proof")) {
