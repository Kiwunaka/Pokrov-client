...
if (Test-Path -LiteralPath $sourcePublicationPacketPath -PathType Leaf) {
  ...
  foreach ($proofRequirement in @("release_evidence_bundle.tag", "publication_dry_run.tag")) {
