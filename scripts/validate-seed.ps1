...
if (Test-Path -LiteralPath $sourcePublicationPacketPath -PathType Leaf) {
  ...
  foreach ($proofRequirement in @("release_evidence_bundle.tag", "release_evidence_bundle.commit_sha", "release_evidence_bundle.source_archive_sha256", "publication_dry_run.tag", "publication_dry_run.commit_sha", "publication_dry_run.source_archive_sha256")) {
