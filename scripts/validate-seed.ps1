...
if (Test-Path -LiteralPath $sourcePublicationPacketPath -PathType Leaf) {
  ...
  foreach ($proofRequirement in @("proof_manifest.source_archive_sha256", "publication_dry_run.source_archive_sha256")) {
