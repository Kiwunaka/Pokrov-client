    ...
    def _handle(self, method: str) -> None:
        ...
        if mode == "401" and path != "/health":
            self._send_json(
                ...
                {"ok": False, "error": "fixture unauthorized mode"},
            )
            return
        ...
        if mode == "500" and path != "/health":
            self._send_json(
                ...
                {"ok": False, "error": "fixture server error mode"},
            )
            return
        ...
        self._send_json(
            ...
            {"ok": False, "error": f"No fixture route for {method} {path}"},
        )
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--mode",
        default="success",
        choices=["success", "401", "500", "malformed-profile", "timeout"],
    )
