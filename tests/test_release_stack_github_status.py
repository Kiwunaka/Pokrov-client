...
def test_release_stack_github_status_rejects_missing_pr_url(
    ...
    assert "PR #160 pull request URL is missing" in summary["errors"]
...
def test_release_stack_github_status_rejects_wrong_repository_pr_url(
    ...
    snapshot = _snapshot_for_stack()
    snapshot[-1]["url"] = "https://github.com/example/fork/pull/160"
    ...
    assert "PR #160 pull request URL does not match expected repository" in summary[
        "errors"
    ]
