...
## v0.136.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #157: seed validation requires release stack GitHub status required checks
  to match `config/required-checks.seed.json` exactly
