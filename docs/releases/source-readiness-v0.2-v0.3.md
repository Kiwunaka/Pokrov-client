...
## v0.86.0-source Candidate

Status: stacked PR green, not tagged.

Current evidence:

- PR #107: release merge handoff carries tag-readiness input fingerprints from
  source tag readiness into maintainer handoff evidence
