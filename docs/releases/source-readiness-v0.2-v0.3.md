...
## v0.85.0-source Candidate

Status: stacked PR green, not tagged.

Current evidence:

- PR #105: source tag readiness records input fingerprints for the release
  blocker inventory and source-readiness seed files
