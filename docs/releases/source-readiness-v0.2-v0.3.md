...
- PR #192: source publication gate recalculates source publication packet input
  fingerprints before manual source-only GitHub Release publication
...
- confirm `scripts/check-source-publication-gate.ps1` writes
  `build/source-publication-gate/v0.171.0-source/v0.171.0-source-publication-gate.json`
  with `publication_gate_ready_for_manual_publish: true`
- confirm edited, missing, or mismatched input summaries referenced by
  `input_fingerprints` return exit `2` and keep
...
- PR #190: source publication gate makes the source publication packet an
...
- run the source preflight, release evidence bundle, publication dry-run, tag
  ...
  publication gate commands from the same candidate
- confirm `scripts/check-source-publication-gate.ps1` writes
  `build/source-publication-gate/v0.169.0-source/v0.169.0-source-publication-gate.json`
  with `publication_gate_ready_for_manual_publish: true`
- confirm stale, unsafe, or unready source publication packets return exit `2`
  and keep `publication_gate_ready_for_manual_publish: false`
- keep the source-only boundary: no APK, EXE, store release, trusted signing, or
  official binary claim

## v0.168.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #189: source publication packet carries and validates the release handoff
  GitHub ruleset report proof as explicit review evidence
...
- run the source preflight, release evidence bundle, publication dry-run, tag
  ...
  the same candidate
- confirm the generated source publication packet carries
  `release_handoff_github_ruleset_report`
- confirm missing or mismatched release handoff GitHub ruleset report fields
  block packet readiness before manual GitHub Release review
- keep the source-only boundary: no APK, EXE, store release, trusted signing, or
  official binary claim

## v0.167.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #188: source publication packet carries and validates the release handoff
  Windows bundle verifier proof as explicit review evidence
...
- run the source preflight, release evidence bundle, publication dry-run, tag
  ...
  the same candidate
- confirm the generated source publication packet carries
  `release_handoff_windows_bundle_verifier_ok` and
  `release_handoff_windows_bundle_verifier_summary`
- confirm missing release handoff Windows bundle verifier fields block packet
  generation
- confirm mismatched release handoff Windows bundle verifier status or summary
  blocks packet generation
- keep release notes source-only with no APK, EXE, store, trusted-signing, or
  official binary claims

## v0.166.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #187: source publication packet carries and validates the release handoff
  publication dry-run evidence bundle preflight ref commit SHA as explicit
  review proof
...
- run the source preflight, release evidence bundle, publication dry-run, tag
  ...
  the same candidate
- confirm the generated source publication packet carries
  `release_handoff_publication_dry_run_evidence_bundle_preflight_ref_commit_sha`
- confirm missing release handoff
  `publication_dry_run_evidence_bundle_preflight_ref_commit_sha` blocks packet
  generation
- confirm mismatched release handoff publication dry-run evidence bundle
  preflight ref commit SHA blocks packet generation
- keep release notes source-only with no APK, EXE, store, trusted-signing, or
  official binary claims

## v0.165.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #186: source publication packet carries and validates the release handoff
  publication dry-run evidence bundle preflight commit SHA as explicit review
  proof
...
- run the source preflight, release evidence bundle, publication dry-run, tag
  ...
  the same candidate
- confirm the generated source publication packet carries
  `release_handoff_publication_dry_run_evidence_bundle_preflight_commit_sha`
- confirm missing release handoff
  `publication_dry_run_evidence_bundle_preflight_commit_sha` blocks packet
  generation
- confirm mismatched release handoff publication dry-run evidence bundle
  preflight commit SHA blocks packet generation
- keep release notes source-only with no APK, EXE, store, trusted-signing, or
  official binary claims

## v0.164.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #185: source publication packet carries and validates the release handoff
  publication dry-run source archive SHA-256 as explicit review proof
...
- run the source preflight, release evidence bundle, publication dry-run, tag
  ...
  the same candidate
- confirm the generated source publication packet carries
  `release_handoff_publication_dry_run_source_archive_sha256`
- confirm missing release handoff `publication_dry_run_source_archive_sha256`
  blocks packet generation
- confirm mismatched release handoff publication dry-run source archive SHA
  blocks packet generation
- keep release notes source-only with no APK, EXE, store, trusted-signing, or
  official binary claims

## v0.163.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #184: release merge handoff carries and requires the publication dry-run
  source archive SHA-256 as explicit maintainer proof
...
- run the source preflight, release evidence bundle, publication dry-run, tag
  readiness, release merge handoff, and source publication packet commands from
  the same candidate
- confirm the release merge handoff summary carries
  `publication_dry_run_source_archive_sha256`
- confirm missing publication dry-run source archive SHA-256 blocks handoff
- keep release notes source-only with no APK, EXE, store, trusted-signing, or
  official binary claims

## v0.162.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #183: source publication packet carries and validates the release handoff
  publication dry-run commit SHA as explicit review proof
...
- run the source preflight, release evidence bundle, publication dry-run, tag
  readiness, release merge handoff, and source publication packet commands from
  the same candidate
- confirm the source publication packet summary carries
  `release_handoff_publication_dry_run_commit_sha`
- confirm stale or missing handoff commit SHA evidence blocks the packet
- keep release notes source-only with no APK, EXE, store, trusted-signing, or
  official binary claims

## v0.161.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #182: source publication packet carries the release handoff publication
  dry-run source archive filename as explicit review proof
...
- run the source preflight, release evidence bundle, publication dry-run, tag
  ...
  the same candidate
- confirm the source publication packet summary carries
  `release_handoff_publication_dry_run_source_archive`
- keep release notes source-only with no APK, EXE, store, trusted-signing, or
  official binary claims

## v0.160.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #181: source publication packet validates the release handoff publication
  dry-run source archive filename before manual GitHub Release review
...
- run the source preflight, release evidence bundle, publication dry-run, tag
  readiness, release merge handoff, and source publication packet commands from
  the same candidate
- confirm the source publication packet rejects release handoff summaries whose
  `publication_dry_run_source_archive` differs from the publication dry-run
  `source_archive`
- keep release notes source-only with no APK, EXE, store, trusted-signing, or
  official binary claims

## v0.159.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #180: release merge handoff carries the publication dry-run source archive
  filename as explicit maintainer proof
...
- run the source preflight, release evidence bundle, publication dry-run, tag
  ...
  the same candidate
- confirm the release merge handoff summary carries
  `publication_dry_run_source_archive` from the publication dry-run summary
- keep release notes source-only with no APK, EXE, store, trusted-signing, or
  official binary claims

## v0.158.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #179: publication dry-run carries the release evidence bundle source
  archive filename as explicit handoff proof
...
- run the source preflight, release evidence bundle, publication dry-run, tag
  readiness, release merge handoff, and source publication packet commands from
  the same candidate
- confirm the publication dry-run summary carries both `source_archive` and
  `source_archive_sha256` from the release evidence bundle before handoff
- keep release notes source-only with no APK, EXE, store, trusted-signing, or
  official binary claims

## v0.157.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #178: publication dry-run validates release evidence bundle source archive
  filename binding before manual GitHub Release review
...
- run the source preflight, release evidence bundle, publication dry-run, tag
  readiness, release merge handoff, and source publication packet commands from
  the same candidate
- confirm the publication dry-run rejects release evidence bundles whose
  `source_archive` filename differs from the carried source archive artifact
  fingerprint
- keep release notes source-only with no APK, EXE, store, trusted-signing, or
  official binary claims

## v0.156.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #177: source publication packet validates release evidence bundle source
  archive filename binding before manual GitHub Release review
...
- confirm the source publication packet binds the proof manifest
  and release evidence bundle `tag`, `commit_sha`, `source_archive`, and
  `source_archive_sha256` values to the exact source tag, commit, and source
  archive selected by the publication dry-run proof
- keep release notes source-only with no APK, EXE, store, trusted-signing, or
  official binary claims

## v0.155.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #176: source publication packet validates release evidence bundle source
  archive SHA binding before manual GitHub Release review
...
- run the source preflight, release evidence bundle, publication dry-run, tag
  ...
  the same candidate
- confirm the source publication packet binds the proof manifest
  and release evidence bundle `tag`, `commit_sha`, and `source_archive_sha256`
  values to the exact source tag, commit, and source archive selected by the
  publication dry-run proof
- keep release notes source-only with no APK, EXE, store, trusted-signing, or
  official binary claims

## v0.154.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #175: source publication packet validates release evidence bundle commit SHA
  binding before manual GitHub Release review
...
- run the source preflight, release evidence bundle, publication dry-run, tag
  ...
  the same candidate
- confirm the source publication packet binds the proof manifest
  and release evidence bundle `tag` and `commit_sha` values to the exact source
  tag and commit selected by the publication dry-run proof
- keep release notes source-only with no APK, EXE, store, trusted-signing, or
  official binary claims

## v0.153.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #174: source publication packet validates release evidence bundle tag
  binding before manual GitHub Release review
...
- run the source preflight, release evidence bundle, publication dry-run, tag
  ...
  the same candidate
- confirm the source publication packet binds the proof manifest
  and release evidence bundle `tag` values to the exact source tag selected by
  the publication dry-run proof
- keep release notes source-only with no APK, EXE, store, trusted-signing, or
  official binary claims

## v0.152.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #173: source publication packet validates proof manifest tag binding before
...
- run the source preflight, release evidence bundle, publication dry-run, tag
  ...
  the same candidate
- confirm the source publication packet binds the proof manifest
  `tag` to the exact source tag selected by the publication dry-run proof
- keep release notes source-only with no APK, EXE, store, trusted-signing, or
  official binary claims

## v0.151.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #172: source publication packet validates proof manifest commit SHA binding
...
- run the source preflight, release evidence bundle, publication dry-run, tag
  ...
  the same candidate
- confirm the source publication packet binds the proof manifest
  `commit_sha` to the exact commit SHA selected by the publication dry-run
  proof
- keep release notes source-only with no APK, EXE, store, trusted-signing, or
  official binary claims

## v0.150.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #171: source publication packet validates proof manifest source archive
  filename binding before manual GitHub Release review
...
- run the source preflight, release evidence bundle, publication dry-run, tag
  ...
  the same candidate
- confirm the source publication packet binds the proof manifest
  `source_archive` filename to the exact source archive artifact selected by
  the publication dry-run proof
- keep release notes source-only with no APK, EXE, store, trusted-signing, or
  official binary claims

## v0.147.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #168: source publication packet validates release notes claim and
  known-limitation markers before manual GitHub Release review
...
- run the source preflight, release evidence bundle, publication dry-run, tag
  readiness, release merge handoff, and source publication packet commands from
  the same candidate
- confirm rendered release notes include source-only, no-binary, no-store,
  no-trusted-signing, official-binary boundary, included-scope, and
  known-limitation markers without `TBD` placeholders
- keep release notes source-only with no APK, EXE, store, trusted-signing, or
  official binary claims

## v0.146.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #167: source publication packet validates source release artifact JSON
  schemas before manual GitHub Release review
...
- run the source preflight, release evidence bundle, publication dry-run, tag
  readiness, release merge handoff, and source publication packet commands from
  the same candidate
- confirm source proof, release evidence, preflight, Windows verifier, and
  optional ruleset JSON artifacts carry their expected source-only proof fields
- keep release notes source-only with no APK, EXE, store, trusted-signing, or
  official binary claims

## v0.145.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #166: source publication packet validates source release artifact contents
  before manual GitHub Release review
...
- run the source preflight, release evidence bundle, publication dry-run, tag
  readiness, release merge handoff, and source publication packet commands from
  the same candidate
- confirm release notes are readable Markdown, manifests/evidence/proof files
  are parseable JSON, and source archives are valid non-empty ZIP files
- keep release notes source-only with no APK, EXE, store, trusted-signing, or
  official binary claims

## v0.144.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #165: source publication packet rejects release artifact files whose
  extensions do not match the source-only artifact contract
...
- run the source preflight, release evidence bundle, publication dry-run, tag
  readiness, release merge handoff, and source publication packet commands from
  the same candidate
- confirm source archives use `.zip`, release notes use `.md`, and manifests,
  evidence bundles, preflight proof, Windows verifier summaries, and optional
  ruleset reports use `.json`
- keep release notes source-only with no APK, EXE, store, trusted-signing, or
  official binary claims

## v0.143.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #164: source publication packet rejects unexpected non-source release
  asset fingerprints before manual GitHub Release review
...
- run the source preflight, release evidence bundle, publication dry-run, tag
  readiness, release merge handoff, and source publication packet commands from
  the same candidate
- confirm release asset fingerprints stay limited to the source-only allowlist
  and do not include APK, EXE, installer, store, signing, or packaged binary
  artifacts
- keep release notes source-only with no APK, EXE, store, trusted-signing, or
  official binary claims

## v0.142.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #163: source publication packet rejects release artifact paths outside
  the expected build output roots before manual GitHub Release review
...
- run the source preflight, release evidence bundle, publication dry-run, tag
  readiness, release merge handoff, and source publication packet commands from
  the same candidate
- confirm release notes, proof manifests, source archives, evidence bundles,
  preflight proof, Windows verifier summaries, and optional GitHub ruleset
  reports come from their expected ignored `build/` output roots
- keep release notes source-only with no APK, EXE, store, trusted-signing, or
  official binary claims

## v0.141.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #162: source publication packet recalculates release artifact file
  fingerprints before manual GitHub Release review
...
- run the source preflight, release evidence bundle, publication dry-run, tag
  readiness, release merge handoff, and source publication packet commands from
  the same candidate
- confirm stale release notes, proof manifests, source archives, evidence
  bundles, preflight proof, or Windows verifier summaries block manual
  publication review
- keep release notes source-only with no APK, EXE, store, trusted-signing, or
  official binary claims

## v0.140.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #161: source publication packet validates handoff-carried publication
  dry-run fingerprints against the direct dry-run summary before manual release
  review
...
- run the source preflight, release evidence bundle, publication dry-run, tag
  readiness, release merge handoff, and source publication packet commands from
  the same candidate
- confirm stale or mismatched handoff-carried publication dry-run fingerprints
  block manual publication review
- keep release notes source-only with no APK, EXE, store, trusted-signing, or
  official binary claims

## v0.139.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #160: source publication packet validates release handoff and publication
  dry-run generated_at timestamps before manual GitHub Release review
...
- run the source preflight, release evidence bundle, publication dry-run, tag
  readiness, release merge handoff, and source publication packet commands from
  the same candidate
- confirm stale or malformed packet input timestamps block manual publication
  review
- keep release notes source-only with no APK, EXE, store, trusted-signing, or
  official binary claims

## v0.138.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #159: source publication packet consolidates release handoff,
  publication dry-run, source proof artifacts, and source-only flags for manual
...
- run the source preflight, release evidence bundle, publication dry-run, tag
  readiness, release merge handoff, and source publication packet commands from
  the same candidate
- review `build/source-publication-packet/<tag>/source-publication-packet.json`
  before manual GitHub Release publication
- keep release notes source-only with no APK, EXE, store, trusted-signing, or
  official binary claims

## v0.137.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #158: seed validation requires active-range source-readiness stacked PR
  milestones to be covered by the release merge-order stack
...
- confirm `scripts/validate-seed.ps1` rejects source-readiness milestone
  evidence drift from `config/release-merge-order.seed.json`
- keep release notes source-only with no APK, EXE, store, trusted-signing, or
  official binary claims

## v0.124.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #145: source tag readiness rejects tag creation allowance while the
  selected source-readiness milestone is still pending or not tagged
...
- run the source preflight, release evidence bundle, publication dry-run, tag
  readiness, and release merge handoff commands from the same candidate
- confirm source tag readiness reports an error if tag creation is allowed
  before the selected source-readiness milestone is no longer pending/not tagged
- keep release notes source-only with no APK, EXE, store, trusted-signing, or
  official binary claims

## v0.123.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #144: source tag readiness rejects blocker inventories that claim ready
  status while required release blockers remain open
...
- run the source preflight, release evidence bundle, publication dry-run, tag
  readiness, and release merge handoff commands from the same candidate
- confirm source tag readiness reports an error if blocker inventory claims
  ready status before required blockers are cleared
- keep release notes source-only with no APK, EXE, store, trusted-signing, or
  official binary claims

## v0.122.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #143: source tag readiness rejects contradictory blocker inventories that
  set `tag_creation_allowed=true` while required blockers remain open or
  release blocker inventory status is not ready
...
- run the source preflight, release evidence bundle, publication dry-run, tag
  readiness, and release merge handoff commands from the same candidate
- confirm source tag readiness reports an error if blocker inventory allows tag
  creation before blockers and inventory status are actually ready
- keep release notes source-only with no APK, EXE, store, trusted-signing, or
  official binary claims

## v0.121.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #142: release evidence rejects stale preflight summaries and publication
  dry-run rejects stale evidence bundles before those artifacts can feed
  maintainer handoff
...
- run the source preflight, release evidence bundle, publication dry-run, tag
  readiness, and release merge handoff commands from the same candidate
- confirm release evidence and publication dry-run were generated from fresh
  upstream summaries before using them as release evidence
- confirm all generated handoff input summaries are fresh before using the
  maintainer handoff as release evidence
- when a GitHub ruleset report is present, confirm `checked_at` is fresh before
  carrying any GitHub enforcement claim
- keep release notes source-only with no APK, EXE, store, trusted-signing, or
  official binary claims

## v0.120.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #141: release merge handoff rejects missing, invalid, stale, or
  too-far-future `generated_at` timestamps on merge order, GitHub status, tag
  readiness, and publication dry-run input summaries before maintainer review
...
## v0.119.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #140: release evidence, publication dry-run, and release merge handoff
  reject GitHub ruleset verifier reports without a fresh `checked_at` timestamp
  before carrying any GitHub enforcement claim
...
## v0.118.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #139: GitHub ruleset verifier reports the canonical CI jobs it covered in
  `covered_required_status_checks`, and release evidence, publication dry-run,
  and release merge handoff reject `ok` reports whose covered checks do not
  match `config/required-checks.seed.json`
...
- run the source preflight, release evidence bundle, publication dry-run, tag
  readiness, and release merge handoff commands from the same candidate
- when a GitHub ruleset report is present and claims `ok: true`, confirm
  `covered_required_status_checks` matches every canonical required CI job
  before carrying any GitHub enforcement claim
- keep release notes source-only with no APK, EXE, store, trusted-signing, or
  official binary claims

## v0.117.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #138: release evidence, publication dry-run, and release merge handoff
  reject GitHub ruleset verifier reports whose passing `checks` do not cover
  every canonical required CI job in `config/required-checks.seed.json`
...
- run the source preflight, release evidence bundle, publication dry-run, tag
  readiness, and release merge handoff commands from the same candidate
- when a GitHub ruleset report is present and claims `ok: true`, confirm
  passing verifier checks cover every canonical required CI job before carrying
  any GitHub enforcement claim
- keep release notes source-only with no APK, EXE, store, trusted-signing, or
  official binary claims

## v0.116.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #137: release evidence, publication dry-run, and release merge handoff
  reject GitHub ruleset verifier reports whose `required_status_checks` list
  does not match the canonical required CI jobs in
...
- run the source preflight, release evidence bundle, publication dry-run, tag
  readiness, and release merge handoff commands from the same candidate
- when a GitHub ruleset report is present, confirm `required_status_checks`
  matches the canonical required CI list before carrying any GitHub enforcement
  claim
- keep release notes source-only with no APK, EXE, store, trusted-signing, or
  official binary claims

## v0.115.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #136: release evidence, publication dry-run, and release merge handoff
  reject GitHub ruleset verifier check entries that omit traceable `name` or
  `status` fields
...
- run the source preflight, release evidence bundle, publication dry-run, tag
  readiness, and release merge handoff commands from the same candidate
- when a GitHub ruleset report is present and claims `ok: true`, confirm every
  verifier check entry carries traceable name and status fields before carrying
  any GitHub enforcement claim
- keep release notes source-only with no APK, EXE, store, trusted-signing, or
  official binary claims

## v0.114.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #135: release evidence, publication dry-run, and release merge handoff
  reject GitHub ruleset verifier reports that claim `ok: true` without
  verifier checks or while any verifier check is failed
...
- run the source preflight, release evidence bundle, publication dry-run, tag
  readiness, and release merge handoff commands from the same candidate
- when a GitHub ruleset report is present and claims `ok: true`, confirm the
  verifier checks are present and passing before carrying any GitHub
  enforcement claim
- keep release notes source-only with no APK, EXE, store, trusted-signing, or
  official binary claims

## v0.113.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #134: release evidence, publication dry-run, and release merge handoff
  reject GitHub ruleset verifier reports whose `repository` or `branch` target
  does not match `Kiwunaka/Pokrov-client` on `main`
...
- run the source preflight, release evidence bundle, publication dry-run, tag
  readiness, and release merge handoff commands from the same candidate
- when a GitHub ruleset report is present, confirm it targets
  `Kiwunaka/Pokrov-client` on `main` before carrying any GitHub enforcement
  claim
- keep release notes source-only with no APK, EXE, store, trusted-signing, or
  official binary claims

## v0.112.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #133: release merge handoff rejects malformed, missing-schema,
  missing-status, or non-read-only GitHub ruleset verifier reports carried by
  publication dry-run before maintainer handoff can be marked ready
...
- run the source preflight, release evidence bundle, publication dry-run, tag
  readiness, and release merge handoff commands from the same candidate
- when a GitHub ruleset report is present, confirm release evidence,
  publication dry-run, and release merge handoff all reject malformed verifier
  JSON before carrying any GitHub enforcement claim
- keep release notes source-only with no APK, EXE, store, trusted-signing, or
  official binary claims

## v0.111.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #132: publication dry-run rejects malformed, missing-schema,
  missing-status, or non-read-only GitHub ruleset verifier reports from release
  evidence before manual release review or release merge handoff
...
- run the source preflight, release evidence bundle, publication dry-run, tag
  readiness, and release merge handoff commands from the same candidate
- when a GitHub ruleset report is present, confirm both release evidence and
  publication dry-run reject malformed verifier JSON before carrying any
  GitHub enforcement claim
- keep release notes source-only with no APK, EXE, store, trusted-signing, or
  official binary claims

## v0.110.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #131: release evidence rejects malformed, missing-schema, missing-status,
  or non-read-only GitHub ruleset verifier reports before enforcement claims can
  reach publication dry-run or release merge handoff
...
- run the source preflight, release evidence bundle, publication dry-run, tag
  readiness, and release merge handoff commands from the same candidate
- when a GitHub ruleset report is present, confirm it carries
  `schema_version: 1`, `read_only: true`, and an explicit `ok` status before
  relying on any GitHub enforcement claim
- keep release notes source-only with no APK, EXE, store, trusted-signing, or
  official binary claims

## v0.109.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #130: release evidence records optional GitHub ruleset report input
  fingerprints, publication dry-run verifies them before allowing enforcement
  claims, and release merge handoff rejects stale ruleset report fingerprints
  before maintainer handoff can be marked ready
...
- run the source preflight, release evidence bundle, publication dry-run, tag
  readiness, and release merge handoff commands from the same candidate
- when a GitHub ruleset report is present, confirm release evidence,
  publication dry-run, and release merge handoff agree on
  `input_fingerprints.github_ruleset_report`
- keep release notes source-only with no APK, EXE, store, trusted-signing, or
  official binary claims

## v0.108.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #129: release merge handoff validates publication dry-run
  `evidence_bundle_preflight_artifact_fingerprints` against the real proof
  manifest, source archive, release notes, and Windows verifier files before
...
- confirm release merge handoff has no
  `publication dry-run artifact fingerprints mismatch` blocker
- keep release notes source-only with no APK, EXE, store, trusted-signing, or
  official binary claims
...
- PR #127: release merge handoff validates publication dry-run direct
  `input_fingerprints.evidence_bundle` and `input_fingerprints.release_notes`
  against the real files before maintainer handoff can be marked ready

Required before tagging:

- merge the stacked PR sequence through `main`
- choose the exact commit SHA
- run the source preflight, release evidence bundle, publication dry-run, and
  release merge handoff commands from the same candidate
- confirm release merge handoff has no
  `publication dry-run input fingerprints mismatch` blocker
- keep release notes source-only with no APK, EXE, store, trusted-signing, or
  official binary claims

## v0.105.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #126: release merge handoff validates publication dry-run
  `evidence_bundle_input_fingerprints.preflight_summary` against the real
  preflight summary file before maintainer handoff can be marked ready
...
- run the source preflight, release evidence bundle, publication dry-run, and
  release merge handoff commands from the same candidate
- confirm release merge handoff has no
  `publication dry-run preflight input fingerprint mismatch` blocker
- keep release notes source-only with no APK, EXE, store, trusted-signing, or
  official binary claims
...
- PR #124: release stack GitHub status records per-check GitHub Actions trace
  evidence, and release merge handoff validates every GitHub status PR check
  trace before maintainer handoff can be marked ready
...
- run `scripts/check-release-stack-github-status.ps1` and confirm every
  `pull_requests` check entry records `details_url` and `workflow_name`
- run `scripts/prepare-release-merge-handoff.ps1` and confirm the handoff
  rejects missing or non-GitHub-Actions check trace evidence
...
## v0.102.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #123: release stack GitHub status records per-PR required check evidence,
  and release merge handoff validates every GitHub status PR check before
  maintainer handoff can be marked ready
...
- choose the exact commit SHA
- run `scripts/check-release-stack-github-status.ps1` and confirm every
  `pull_requests` entry records the required status check names and successful
  status/conclusion values
- run `scripts/prepare-release-merge-handoff.ps1` and confirm the handoff
  records `github_status_pr_checks`
- run the full source release preflight on the exact annotated tag with
  `scripts/source-release-preflight.ps1 -RequireTag`
- review source-only release notes and evidence bundle
...
- PR #121: release merge handoff validates every GitHub status PR URL against
  the expected public repository prefix and merge-order PR number before
  maintainer handoff can be marked ready
...
- run `scripts/check-release-stack-github-status.ps1` and confirm
  `pull_requests` covers the release stack with expected PR URLs
- run `scripts/prepare-release-merge-handoff.ps1` and confirm the handoff
  records `github_status_pr_urls`
- run the full source release preflight on the exact annotated tag with
  `scripts/source-release-preflight.ps1 -RequireTag`
- review source-only release notes and evidence bundle
...
## v0.99.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #120: release merge handoff validates that GitHub status PR base/head
  refs match the merge-order stack before maintainer handoff can be marked
  ready
...
- choose the exact commit SHA
- run `scripts/check-release-stack-github-status.ps1` and confirm
  `pull_requests` covers the release stack with expected PR refs
- run `scripts/prepare-release-merge-handoff.ps1` and confirm the handoff
  records `github_status_pr_refs`
- run the full source release preflight on the exact annotated tag with
  `scripts/source-release-preflight.ps1 -RequireTag`
- review source-only release notes and evidence bundle
...
## v0.98.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #119: release merge handoff validates that GitHub status PR sequence
  matches the merge-order stack before maintainer handoff can be marked ready
...
- choose the exact commit SHA
- run `scripts/check-release-stack-github-status.ps1` and confirm
  `pull_requests` covers the release stack in the expected order
- run `scripts/prepare-release-merge-handoff.ps1` and confirm the handoff
  records `github_status_pr_sequence`
- run the full source release preflight on the exact annotated tag with
  `scripts/source-release-preflight.ps1 -RequireTag`
- review source-only release notes and evidence bundle
...
## v0.97.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #118: release merge handoff validates that GitHub status pull request
  entries are present, complete for the stack, and aligned with the latest PR
  URL before maintainer handoff can be marked ready
...
- choose the exact commit SHA
- run `scripts/check-release-stack-github-status.ps1` and confirm
  `pull_requests` covers the release stack
- run `scripts/prepare-release-merge-handoff.ps1` and confirm the handoff
  records `github_status_pull_request_count`
- run the full source release preflight on the exact annotated tag with
  `scripts/source-release-preflight.ps1 -RequireTag`
- review source-only release notes and evidence bundle
...
## v0.96.0-source Candidate

Status: pending stacked PR, not tagged.

Current evidence:

- PR #117: release merge handoff validates GitHub status summary counts
  against the merge stack and configured required status checks before
  maintainer handoff can be marked ready
...
- merge the stacked PR sequence through `main`
- choose the exact commit SHA
- run `scripts/check-release-stack-github-status.ps1` and confirm clean PR
  counts and successful status-check counts match the release stack
- run `scripts/prepare-release-merge-handoff.ps1` and confirm the handoff
  records `github_status_counts`
- run the full source release preflight on the exact annotated tag with
  `scripts/source-release-preflight.ps1 -RequireTag`
- review source-only release notes and evidence bundle
