...
URL-подписки, QR-импорт, список сохранённых профилей и опциональный каталог
...
| Community mode | MVP локального импорта одиночного ключа |
