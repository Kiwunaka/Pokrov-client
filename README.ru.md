...
Source readiness note: `v0.151.0-source` is a pending stacked PR for verifying
that the source publication packet validates proof manifest commit SHA binding
before manual GitHub Release review; it is not tagged and does not ship APK/EXE
binaries.

Source readiness note: `v0.152.0-source` is a pending stacked PR for verifying
that the source publication packet validates proof manifest tag binding before
...
Source readiness note: `v0.154.0-source` is a pending stacked PR for verifying
that the source publication packet validates release evidence bundle commit SHA
binding before manual GitHub Release review; it is not tagged and does not ship
APK/EXE binaries.

Source readiness note: `v0.155.0-source` is a pending stacked PR for verifying
that the source publication packet validates release evidence bundle source
archive SHA binding before manual GitHub Release review; it is not tagged and
does not ship APK/EXE binaries.

Source readiness note: `v0.156.0-source` is a pending stacked PR for verifying
that the source publication packet validates release evidence bundle source
archive filename binding before manual GitHub Release review; it is not tagged
and does not ship APK/EXE binaries.

Source readiness note: `v0.157.0-source` is a pending stacked PR for verifying
that the publication dry-run validates release evidence bundle source archive
filename binding before manual GitHub Release review; it is not tagged and does
not ship APK/EXE binaries.
...
Source readiness note: `v0.160.0-source` is a pending stacked PR for verifying
that the source publication packet validates the release handoff publication
dry-run source archive filename before manual GitHub Release review; it is not
tagged and does not ship APK/EXE binaries.

Source readiness note: `v0.161.0-source` is a pending stacked PR for verifying
that the source publication packet carries the release handoff publication
...
Source readiness note: `v0.163.0-source` is a pending stacked PR for verifying
that the release merge handoff carries and requires the publication dry-run
...
Source readiness note: `v0.165.0-source` is a pending stacked PR for verifying
that the source publication packet carries and validates the release handoff
publication dry-run evidence bundle preflight commit SHA as explicit review
proof; it is not tagged and does not ship APK/EXE binaries.

Source readiness note: `v0.166.0-source` is a pending stacked PR for verifying
that the source publication packet carries and validates the release handoff
publication dry-run evidence bundle preflight ref commit SHA as explicit review
proof; it is not tagged and does not ship APK/EXE binaries.

Source readiness note: `v0.167.0-source` is a pending stacked PR for verifying
that the source publication packet carries and validates the release handoff
Windows bundle verifier proof as explicit review evidence; it is not tagged and
does not ship APK/EXE binaries.

Source readiness note: `v0.168.0-source` is a pending stacked PR for verifying
that the source publication packet carries and validates the release handoff
...
Source readiness note: `v0.170.0-source` is a pending stacked PR for verifying
that the source publication gate recalculates source publication packet artifact
fingerprints before manual source-only GitHub Release publication; it is not
tagged and does not ship APK/EXE binaries.

Source readiness note: `v0.171.0-source` is a pending stacked PR for verifying
that the source publication gate recalculates source publication packet input
fingerprints before manual source-only GitHub Release publication; it is not
tagged and does not ship APK/EXE binaries.
